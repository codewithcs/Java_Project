...
public class AnalyserIntegrationTest {
    ...
    void test_sort_and_print_method() throws IOException, URISyntaxException {
        ...
        String actualResult = analyser.sortAndPrint((inventory.getParsedInventory()));
        String expectedResult = Files.lines(Paths.get(Objects.requireNonNull(getClass().getClassLoader()
    ...
    void test_get_avg_price_method(){
        double actualResult = analyser.computeAvgPriceOfAllComponents((inventory.getParsedInventory()));
        assertEquals(145.83, actualResult);
    }

    @Test
    void test_get_avg_price_of_cpu_components_method(){
        double actualResult = analyser.computeAvgPriceOfCPUComponents((inventory.getParsedInventory()));
